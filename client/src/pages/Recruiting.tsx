      ...
      <main className="inner-main">
        <section className="page-intro recruiting-intro">
          ...
          <div className="recruiting-title-row">
            <div>
              ...
              <h1>다음 관측을<br /><span>같이 준비한다.</span></h1>
            </div>
            <p className="page-intro-copy">지원에 필요한 내용을 따로 정리한다. 모집 일정과 방법은 이곳과 GBS 학교 공지에서 확인한다.</p>
          </div>
        </section>
        ...
        <section className="recruiting-notice" aria-labelledby="notice-title">
          ...
          <div className="notice-body">
            <h2 id="notice-title">지금은 다음 공지를<br /><span>기다리는 시간이다.</span></h2>
            <div className="notice-copy">
              <p>지원 일정과 방법은 확정 후 GBS 학교 공지와 풀체리마 공식 채널에 게시한다. 궁금한 점은 메일로 남긴다.</p>
        ...
        <section className="recruiting-fit">
          ...
          <div className="fit-grid">
            <h2>별을 잘 몰라도<br /><span>괜찮다.</span></h2>
            <ul>
        ...
        <section className="recruiting-flow">
          ...
          <div className="flow-row">
            <div><strong>01</strong><h3>공지 확인</h3><p>풀체리마 공식 채널과 GBS 학교 공지에서 모집 일정을 확인한다.</p></div>
            <div><strong>02</strong><h3>지원하기</h3><p>지원 방법이 열리면 안내된 방식으로 지원한다.</p></div>
            <div><strong>03</strong><h3>첫 관측</h3><p>새로운 질문을 들고 첫 관측을 준비한다.</p></div>
          </div>
        </section>
