...
const entries = [
  ...
  { no: "03", date: "2026. 03", type: "동아리 기록", title: "첫 관측을 위한 준비", excerpt: "관측 전 체크리스트와 장비를 정리하며 다음 질문을 고른 기록입니다.", image: "https://images.unsplash.com/photo-1456324504439-367cee3b3c32?auto=format&fit=crop&w=1100&q=88" },
];
    ...
    <div className="inner-page archive-page">
      ...
      <main className="inner-main">
        <section className="page-intro archive-intro">
          <div className="page-intro-meta"><span>GBS / 풀체리마</span><span>활동기록소 / 2026—</span></div>
          <div className="page-intro-grid">
            <div>
              <p className="section-kicker">풀체리마 활동기록소</p>
              <h1>우리가 본 것을<br /><span>남겨두는 곳입니다.</span></h1>
            </div>
            <p className="page-intro-copy">관측이 끝난 뒤의 기록과 준비하는 동안의 질문, 함께 보낸 밤의 흔적을 남깁니다. 여기는 풀체리마의 활동기록소입니다.</p>
          </div>
        </section>
        ...
        <section className="archive-next">
          <div><CalendarDays size={18} /><span>다음 기록은 맑은 밤을 기다리고 있습니다.</span></div>
